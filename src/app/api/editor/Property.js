                  ...
                  footer={
                    <div className="grid grid-2">
                      <div className="col-2 col-right">
                        <Button classes="plain text" onClick={this.close}>
                          Done
                        </Button>
                      </div>
                    </div>
        ...
        <div className="property-wrapper">
          <div className="property flex">
            ...
            {this.props.property.relation && (
              <div className="type margin-right-less">
                <Select
                  value={this.props.property.relation}
                  options={[
                    this.props.property.relation,
            ...
            <Button
              type="button"
              classes="text plain btn-small"
              onClick={() => this.props.onDeleteKey(this.props.name)}
            >
